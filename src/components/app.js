...
import { faTrash, faSignOutAlt, faEdit, faVideoSlash, faEnvelopeOpenText, faSpinner } from "@fortawesome/free-solid-svg-icons";
...
library.add(faTrash, faSignOutAlt, faEdit, faVideoSlash, faEnvelopeOpenText, faSpinner);
